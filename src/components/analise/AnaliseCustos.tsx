          ...
          <table className="w-full text-sm text-left border-separate border-spacing-0 whitespace-nowrap table-fixed">
            ...
            <thead className="bg-muted text-muted-foreground">
              <tr>
                ...
                <th className="py-3 px-4 font-semibold border-r border-b sticky z-20 bg-muted" style={{ left: columnWidths.fca }}>
                ...
                <th className="py-3 px-4 font-semibold border-r border-b sticky z-20 bg-muted" style={{ left: columnWidths.fca + columnWidths.ref }}>
                ...
                <th className="py-3 px-4 font-semibold border-r border-b sticky z-20 bg-muted" style={{ left: columnWidths.fca + columnWidths.ref + columnWidths.area }}>
                ...
                <th className="py-3 px-4 font-semibold border-r border-b sticky z-20 bg-muted" style={{ left: columnWidths.fca + columnWidths.ref + columnWidths.area + columnWidths.proj }}>
                ...
                <NumericHeader label="Produção (R$)" col="valorProduzido" className="bg-emerald-50 dark:bg-emerald-950/30 border-r border-b sticky z-20" style={{ left: columnWidths.fca + columnWidths.ref + columnWidths.area + columnWidths.proj + columnWidths.cli }} />
              ...
              {processedRows.map((row) => {
                ...
                return (
                  <tr key={row.key} className="hover:bg-muted/30 transition-colors border-b">
                    ...
                    <td className="py-2 px-4 border-r text-center sticky z-10 bg-background" style={{ left: columnWidths.fca }}>{row.referencia}</td>
                    <td className="py-2 px-4 border-r truncate max-w-[120px] sticky z-10 bg-background" style={{ left: columnWidths.fca + columnWidths.ref }}>{row.area}</td>
                    <td className="py-2 px-4 border-r truncate max-w-[200px] sticky z-10 bg-background" style={{ left: columnWidths.fca + columnWidths.ref + columnWidths.area }}>{row.codigo} - {row.nome}</td>
                    <td className="py-2 px-4 border-r truncate max-w-[160px] sticky z-10 bg-background" style={{ left: columnWidths.fca + columnWidths.ref + columnWidths.area + columnWidths.proj }}>{row.cliente}</td>
                    <td className="py-2 px-4 text-right border-r font-mono text-emerald-600 bg-emerald-50/30 sticky z-10" style={{ left: columnWidths.fca + columnWidths.ref + columnWidths.area + columnWidths.proj + columnWidths.cli }}>{formatCurrency(row.valorProduzido)}</td>
