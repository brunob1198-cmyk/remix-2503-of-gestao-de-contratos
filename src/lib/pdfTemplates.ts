export const pdfGlobalStyles = `
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .foto-group-header { font-size: 12px; font-weight: 700; color: #065f46; background: #d1fae5; border-left: 4px solid #059669; padding: 6px 12px; border-radius: 0 4px 4px 0; margin: 14px 0 8px; page-break-after: avoid; display: flex; align-items: center; }
  </style>
`;
